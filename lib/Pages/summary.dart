...
class Summary extends StatelessWidget {
  ...
  void exportExcel() {
    ...
    final paperCost = (unitPrice1! * rmsPkt1) +
        (unitPrice2! * rmsPkt2) +
        (unitPrice3! * rmsPkt3) +
        (unitPrice4! * rmsPkt4);
    final workCost = (typuni! * typuniprce!) +
        (potouni! * potouniprce!) +
        (desuni! * desuniprce!) +
        (profuni! * profuniprce!) +
        (trauni! * trauniprce!);
    ...
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: 7)).value =
        'RMS/PKT';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: 8)).value =
        rmsPkt1;
    ...
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: 7)).value =
        'Unit Price';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: 8)).value =
        unitPrice1;
    ...
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: 16)).value =
        'Unit Price';
    ...
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: 23)).value =
        'Total Work Cost';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: 23)).value =
        workCost;

    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: 25)).value =
        'Total Cost';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: 25)).value =
        totalCost;
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  color: Colors.white,
                                  child: Text(
                                      '${(typuni! * typuniprce!) + (potouni! * potouniprce!) + (desuni! * desuniprce!) + (profuni! * profuniprce!) + (trauni! * trauniprce!)}'),
                                )
                              ],
                            ),
                          ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  color: Colors.white,
                                  child: Text(
                                      '${((typuni! * typuniprce!) + (potouni! * potouniprce!) + (desuni! * desuniprce!) + (profuni! * profuniprce!) + (trauni! * trauniprce!)) + (unitPrice1! * qty1!) + (unitPrice2! * qty2!) + (unitPrice3! * qty3!) + (unitPrice4! * qty4!)}'),
                                )
                              ],
                            ),
                          )
